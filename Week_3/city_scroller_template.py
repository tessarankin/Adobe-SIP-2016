...
class Building():
    def __init__(self, x_point, y_point, width, height, colour):
    ...
    """
    def draw(self):
        pygame.draw.rect(screen, self.colour, (self.x_point, self.y_point, self.width, self.height))
        """
...
class Scroller(object):
    def __init__(self, width, height, base, colour, speed):
        self.width = width #SCREEN_WIDTH
        self.height = height #SCREEN_HEIGHT
        self.base = base #[(0,800), 600]
        self.colour = colour #random(colors)
        self.speed = speed
        self.building_list = []
    ...
    def add_buildings(self): 
        ...
        while combined_width  <= self.width:
            ...
            self.add_building(combined_width, width)
        """
        Will call add_building until there the buildings fill up the width of the
        scroller.
        """

    def add_building(self, x_location, width):
        building1 = Building(x_location, random.randint(0, 600), width,  random.randint(80, 200), WHITE)
...
# for each building in building_list, for building1 in building_list
        for building_list in self.building_list:
            building1.draw
        """
